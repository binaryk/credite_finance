...
class DocumenteNecesareGrid extends \Credite\GridsRecord
{

    public function __construct($id)
    {
        parent::__construct($id);
        $this->view           = 'banci.documente_necesare.index';
        $this->icon           = 'admin/img/icons/dt/gali.png';
        $this->caption        = 'Documente';
        $this->toolbar        = 'banci.documente_necesare.toolbar';
        $this->name           = 'dt';
        $this->display_start  = 0;
        $this->display_length = 10;
        $this->default_order  = "1,'asc'";
        $this->form           = 'Credite\Banci\Form\DocumenteNecesareForm';
        ...
        $this->row_source     = 'documente_necesare_row_source';
        ...
        $this->columns        = [
            ...
            '2' => [
                ...
                'type'      => 'view',
                'source'    => 'banci.documente_necesare.~file_name', //'proprietari.apartamente.photos.~file_name',
            ],
            '3' => [
                'id'        => 'created_at',
                'orderable' => 'yes',
            ...
            '5' => [
                ...
                'type'      => 'view',
                'source'    => 'banci.documente_necesare.~file_type',
            ],
            '6' => [
                'id'        => 'action',
                'orderable' => 'no',
                ...
                'type'      => 'view',
                'source'    => 'banci.documente_necesare.~actions',
            ],
        ];
        $this->fields = [
            'fields'      => '',
    ...
    {
        return self::$instance = new DocumenteNecesareGrid('documente_necesare');
    }
